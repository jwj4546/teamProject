                    ...
                    <nav id="lnb">
		                ...
		                <div class="contents">
		                    <div class="breadcrumb">
		                        <p>
		                            <a href="">HOME</a><a href="jindallae.jsp">축제</a><span style="color:deeppink">강화 새우젓 축제</span>
		                        </p>
		                    </div>
		                    <h2 class="title">상세보기</h2>
		                    <div class="title2">
		                        <img src="./img/title_img.png" id="title_img">
		                        <h3 class="sub_title">강화새우젓 축제</h3>
		                    </div>
		                    <div class="wrap">
		                        <div class="box_img">
		                            <img src="./img/saewoofestival02.jpg" id="intro_img1">
		                            <img src="./img/saewoofestival01.jpg" id="intro_img2">
		                        </div>
		                        <div class="intro">
                                ...
                                <ul>
                                    <li><a href="http://www.jutgal.co.kr/" target="_blank">
                                    http://www.jutgal.co.kr/<br></a></li>
                                </ul>                 
                        <div class="btn1">
