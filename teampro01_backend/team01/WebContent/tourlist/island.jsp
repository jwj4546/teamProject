                ...
                <aside id="left1">
	                ...
	                <div class="contents">
	                    <div class="breadcrumb">
	                        <p>
	                            <a href="">HOME</a><a href="history.jsp">강화여행</a><span style="color:deeppink">섬</span>
	                        </p>
	                    </div>
	                    <h2 class="title">섬</h2>
	                    <div class="wrap">
	                        <div class="box">
	                            <li>
	                                <a href="seokmodo.jsp"><img src="./img/look4.png" id="cover"></a>
	                                <img src="./img/seokmodo01.jpg" alt="석모도1" id="img">
	                                <span class="text">석모도</span>
	                            </li>
	                            <li>
	                                <a href="gyodongdo.jsp"><img src="./img/look4.png" id="cover"></a>
	                                <img src="./img/gyodong01.jpg" alt="교동도1" id="img">
	                                <span class="text">교동도</span>
	                            </li>
	                            <li>
	                                <a href="jumundo.jsp"><img src="./img/look4.png" id="cover"></a>
	                                <img src="./img/jumundo03.jpg" alt="주문도1" id="img">
