                ...
                <aside id="left1">
	                ...
	                <div class="contents">
	                    <div class="breadcrumb">
	                        <p>
	                            <a href="">HOME</a><a href="farmersmarket.jsp">체험여행</a><span style="color:deeppink">지역시장여행</span>
	                        </p>
	                    </div>
	                    ...
	                    <div class="wrap">
	                        <div class="box">
	                            <li>
	                                <a href="market.jsp"><img src="./img/look4.png" id="cover"></a>
	                                <img src="./img/market01.jpg" alt="풍물시장1" id="img">
	                                <span class="text">강화 풍물시장</span>
	                            </li>
	                            <li>
	                                <a href="insam.jsp"><img src="./img/look4.png" id="cover"></a>
	                                <img src="./img/insam01.jpg" alt="인삼센터1" id="img">
