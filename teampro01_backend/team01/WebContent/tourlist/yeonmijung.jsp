                ...
                <aside id="left1">
	                ...
	                <div class="contents">
	                    <div class="breadcrumb">
	                        <p>
	                            <a href="">HOME</a><a href="history01.jsp">강화여행</a><span style="color:deeppink">유적지</span>
	                        </p>
	                    </div>
	                    ...
	                    <div class="wrap">
	                        <div class="box">
	                            <li>
	                                <a href="gwangseongbo0101.jsp"><img src="./img/look4.png" id="cover"></a>
	                                <img src="./img/gwangseongbo01.jpg" alt="광성보1" id="img">
	                                <span class="text">광성보</span>
	                            </li>
	                            <li>
	                                <a href="gapgot0102.jsp"><img src="./img/look4.png" id="cover"></a>
	                                <img src="./img/gapgotdondae02.jpg" alt="갑곶돈대1" id="img">
	                                <span class="text">갑곶돈대</span>
	                            </li>
	                            <li>
	                                <a href="chojijin0103.jsp"><img src="./img/look4.png" id="cover"></a>
	                        ...
	                        <div class="box">
	                            <li>
	                                <a href="yeonmijung0104.jsp"><img src="./img/look4.png" id="cover"></a>
	                                <img src="./img/yeonmijung01.jpg" alt="연미정1" id="img">
	                                <span class="text">연미정</span>
	                            </li>
	                            <li>
	                                <a href="goryeogungji0105.jsp"><img src="./img/look4.png" id="cover"></a>
	                                <img src="./img/goryeogungji01.jpg" alt="고려궁지1" id="img">
	                                <span class="text">고려궁지</span>
	                            </li>
	                            <li>
	                                <a href="deokjinjin0106.jsp"><img src="./img/look4.png" id="cover"></a>
