                ...
                <nav id="gnb3">
                    <ul class="menu">
                        ...
                        <li>
                            ...
                            <ul class="sub">
                                <li><a href="" class="dp2" id="sub">영화관</a></li>
                                <li><a href="" class="dp2" id="sub">박물관/전시관</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="history.jsp" class="dp1" id="menu3">강화여행</a>
                            <ul class="sub">
                                <li><a href="history.jsp" class="dp2" id="sub">명소</a></li>
                                <li><a href="jindallae.jsp" class="dp2" id="sub">축제</a></li>
                                <li><a href="farmersmarket.jsp" class="dp2" id="sub">체험여행</a></li>
                            </ul>
                        </li>
                        <li>
