...
<header>
	<div class="logo_wrap">
		<a href="${hpath }/pro01"><img src="${hpath }/images/magoklogo.png" alt="마곡동 로고" /></a>
	</div>
	<div id="tnb" style="height:100px; line-height:2rem; padding-top:1rem">
		...
		<c:if test="${empty sid }">
		<h2 style="text-align:left;">마곡에 오신 걸 환영합니다</h2>
		</c:if>
	</div>
	<nav id="gnb">
		<ul class="">
			...
			<li class="item">
				...
				<ul class="sub_menu">
					<li><a href="${hpath }/notice/notiList.jsp">공지사항</a></li>
					<li><a href="">자료실</a></li>
					<li><a href="${hpath }/notice/getNotice.jsp">묻고답하기</a></li>
				</ul>
			</li>
		</ul>
	</nav>
