...
<div id="contents">
	<section class="page" id="page1">
		<div style="width:1400px; margin:0 auto;">
			...
			<form action="${path0 }/notice/editProNotice.jsp" method="post">
				<table class="table">
					<tbody>
						<tr>
				...
				<div class="btn-group">
				  ...
				  <a href="${path0 }/notice/notiList.jsp" class="btn btn-secondary">글 목록</a>
				  <a href="${path0 }/notice/getNotice.jsp?no=${noti.no} " class="btn btn-secondary">글 상세보기</a>
				</div>
			</form>
		</div>
	</section>	
