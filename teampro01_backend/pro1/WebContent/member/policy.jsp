...
<div id="contents">
	<section class="page" id="page1">
		...
		<div style="width:1400px; margin:0 auto;">
			...
			강서구 마곡동 소개에서 운영하는 강서구 마곡동 소개 홈페이지는 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호 및 권익을 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 다음과 같이 개인정보 처리지침을 수립하여 공개합니다.

			제1조(개인정보의 처리목적)
			강서구 마곡동 소개홈페이지는 개인정보를 다음 목적 이외의 용도로는 이용하지 않으며 이용 목적 등이 변경될 경우에는 동의를 받아 처리하겠습니다.
			비회원 민원신청 및 Q&A : 민원처리, 고객응대
			
			제2조(처리하는 개인정보 항목)
			강서구 마곡동 소개홈페이지는 다음의 개인정보 항목을 처리하고 있습니다.
			비회원 민원신청 및 Q&A 관리 - 필수항목 : 성명, 이메일, 연락처
			
			제3조(개인정보의 처리 및 보유기간)
			강서구 마곡동 소개홈페이지는 법령에 따른 개인정보 보유 이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의 받은 개인정보 보유 이용기간 내에서 개인정보를 처리보유합니다.
			민원신청 및 Q&A 신청 비회원 정보 : 3년 (전자상거래 등에서의 소비자보호에 관한 법률 및 시행령)
			
			제4조(개인정보의 제3자 제공)
			강서구 마곡동 소개홈페이지는 개인정보 처리와 관련한 별도의 제3자 제공이 없음을 알려드립니다.
			
			제5조(개인정보처리의 위탁)
			강서구 마곡동 소개 홈페이지는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
			제공받는 자	제공항목	이용목적	보유 및 이용기간
			(주)월드리서치	성명,이메일,휴대폰번호	고객만족도 조사	위탁계약 종료시까지
			
			제6조(정보주체의 권리의무 및 행사방법)
			정보주체는 강서구 마곡동 소개 홈페이지에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
			강서구 마곡동 소개홈페이지에 대해 개인정보보호법 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며, 강서구 마곡동 소개홈페이지는 이에 대해 지체없이 조치하겠습니다.
			...
			제7조(개인정보의 파기)
			강서구 마곡동 소개대표홈페이지는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 다음과 같이 지체없이 해당 개인정보를 파기합니다.
			...
			제8조(개인정보의 안전성 확보조치)
			강서구 마곡동 소개대표홈페이지는 「개인정보보호법」제29조에 따라 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
			관리적 조치 : 내부관리계획 수립ㆍ시행, 개인정보 담당자 대상 정기적 직원 교육 등
			기술적 조치 : 개인정보처리시스템 등의 접근권한 관리, 접근통제시스템 설치, 비밀번호 등의 암호화, 보안프로그램 설치
			물리적 조치 : 전산실, 자료보관실 등의 접근통제
			
			제9조(개인정보 보호책임자)
			강서구 마곡동 소개대표홈페이지는 개인정보를 보호하고 개인정보와 관련된 사항을 처리하기 위하여 아래와 같이 개인정보보호책임자, 개인정보보호담당자 및 개인정보 열람청구를 접수ㆍ처리하는 부서 및 담당자를 지정하고 있습니다.
			관리적 조치 : 내부관리계획 수립ㆍ시행, 개인정보 담당자 대상 정기적 직원 교육 등
			기술적 조치 : 개인정보처리시스템 등의 접근권한 관리, 접근통제시스템 설치, 비밀번호 등의 암호화, 보안프로그램 설치
			물리적 조치 : 전산실, 자료보관실 등의 접근통제
			...
			강서구 마곡동 소개홈페이지는 정보주체의 이용정보를 저장하고 수시로 불러오는 '쿠키(cookie)'를 사용하지 않습니다.
			
			제12조(개인정보 처리방침 변경)
			강서구 마곡동 소개홈페이지의 개인정보처리방침은 시행일로부터 적용되며, 변경이력 및 내용은 아래에서 확인하실 수 있습니다.
