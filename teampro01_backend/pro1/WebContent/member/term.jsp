...
<div id="contents">
	<section class="page" id="page1">
		...
		<div style="width:1400px; margin:0 auto;">
			...
			제 1 조 (목적) 이 이용약관은 “강서구 마곡동 소개 (이하 "당 사이트")”에서 제공하는 인터넷 서비스(이하 '서비스')의 가입조건, 당 사이트와 이용자의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.
			
			제 2 조 (용어의 정의)
			1. "이용자"라 함은 당 사이트에 접속하여 이 약관에 따라 당 사이트가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
			2. “강서구 마곡동 소개”에서 제공하는 단체표준, 단체인증, 예고현황 정보를 말합니다.
			...
			제 7 장 " 강서구 마곡동 소개" 게시물 운영정책
			
			제 20 조 (운영정책)
			"강서구 마곡동 소개" 각종 게시물에 대한 운영정책은 방송통신심의위원회의 정보통신에 관한 심의규정에 기반하며 이를 위반할 경우, "강서구 마곡동 소개" 운영정책에 의해 관련 게시물은 예고 없이 삭제, 이동될 수 있으며, 게시자(회원)는 아이디 이용제한 등 "가산동소개" 이용에 제한을 받을 수 있습니다.
			...
			① 수집항목
			강서구 마곡동 소개은 회원가입 및 기본적인 서비스 제공을 위한 필수정보와 추가적인 서비스 제공 등을 위해 필요한 선택정보로 구분하여 아래와 같은 개인정보를 수집하고 있습니다.
			- 필수항목 : 이름, 이메일, 전화번호, 핸드폰번호, ID, 비밀번호
			- 선택항목 : 해당사항 없음
			선택정보를 입력하지 아니하더라도 서비스 이용에 제한은 없으며, 불가피하게 수집이 필요한 경우 별도의 동의를 받는 등 필요한 조치를 이행하겠습니다.
			
			② 개인정보의 수집ㆍ이용목적
			강서구 마곡동 소개은 수집한 개인정보를 홈페이지 서비스 제공을 위한 회원관리 목적으로만 이용하며, 이용목적이 변경될 경우 별도의 동의를 받는 등 필요한 조치를 이행하겠습니다.
			
			③ 개인정보의 보유ㆍ이용기간
			강서구 마곡동 소개은 이용자의 개인정보를 회원 탈퇴 시까지만 제한적으로 이용하고 있으며, 이용자가 회원 탈퇴를 요청하는 경우 해당 이용자의 개인정보는 지체 없이 파기됩니다.
