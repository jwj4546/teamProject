                ...
                <aside id="left1">
	                ...
	                <div class="contents">
	                    <div class="breadcrumb">
	                        <p>
	                            <a href="">HOME</a><a href="${path0}/travel/history1.jsp">강화여행</a><span style="color:deeppink">섬</span>
	                        </p>
	                    </div>
	                    <h2 class="title">섬</h2>
	                    <div class="wrap">
	                        <div class="box">
	                            <li>
	                                <a href="${path0}/travel/seokmodo4_1.jsp"><img src="${path0 }/images/look4.png" id="cover"></a>
	                                <img src="${path0 }/images/seokmodo01.jpg" alt="석모도1" id="img">
	                                <span class="text">석모도</span>
	                            </li>
	                            <li>
	                                <a href="${path0}/travel/gyodongdo4_2.jsp"><img src="${path0 }/images/look4.png" id="cover"></a>
	                                <img src="${path0 }/images/gyodong01.jpg" alt="교동도1" id="img">
	                                <span class="text">교동도</span>
	                            </li>
	                            <li>
	                                <a href="${path0}/travel/jumundo4_3.jsp"><img src="${path0 }/images/look4.png" id="cover"></a>
	                                <img src="${path0 }/images/jumundo03.jpg" alt="주문도1" id="img">
	                                <span class="text">불음/ 주문도</span>
	                            </li>
	                        </div>
