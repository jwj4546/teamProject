                ...
                <aside id="left1">
	                ...
	                <div class="contents">
	                    <div class="breadcrumb">
	                        <p>
	                            <a href="">HOME</a><a href="${path0}/travel/farmersmarket8.jsp">강화여행</a></a><span style="color:deeppink">레포츠 여행</span>
	                        </p>
	                    </div>
	                    ...
	                    <div class="wrap">
	                        <div class="box">
	                            <li>
	                                <a href="${path0}/travel/monorail10_1.jsp"><img src="${path0 }/images/look4.png" id="cover"></a>
	                                <img src="${path0 }/images/monorail.webp" alt="모노레일1" id="img">
	                                <span class="text">화개산 모노레일</span>
	                            </li>
	                            <li>
	                                <a href="${path0}/travel/luji10_2.jsp"><img src="${path0 }/images/look4.png" id="cover"></a>
	                                <img src="${path0 }/images/ruji03.jpg" alt="루지1" id="img">
	                                <span class="text">루지체험</span>
	                            </li>
	                            <li>
	                                <a href="${path0}/travel/jipline10_3.jsp"><img src="${path0 }/images/look4.png" id="cover"></a>
	                                <img src="${path0 }/images/jipline01.jpg" alt="짚라인1" id="img">
	                                <span class="text">짚라인 체험</span>
	                            </li>
	                        </div>
	                        <div class="box">
	                            <li>
	                                <a href="${path0}/travel/oktoki10_4.jsp"><img src="${path0 }/images/look4.png" id="cover"></a>
	                                <img src="${path0 }/images/sseolmae01.jpg" alt="썰매1" id="img">
