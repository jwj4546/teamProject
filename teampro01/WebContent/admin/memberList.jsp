...
th.item1 { width:52.8px; }
th.item2 { width:105.6px; }
th.item3 { width:211.2px; }
th.item4 { width:105.6px; }
th.item5 { width:158.4px; }
th.item6 { width:211.2px; }
th.item7 { width:211.2px; }
</style>
<title>회원관리</title>
...
#tb1 th.item3, #tb1 td#pw { 
    max-width: 100px; /* 최대 너비 설정 */
    white-space: nowrap; /* 텍스트 줄 바꿈 방지 */
    overflow: hidden; /* 넘치는 부분 숨김 */
    text-overflow: ellipsis; /* 넘치는 부분에 생략 부호 표시 */
}
</style>
</head>
<body>
