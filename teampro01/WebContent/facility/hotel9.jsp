               ...
               <div class="contents">
                   ...
                   <h2 class="title">상세보기</h2>
                    <div class="title2">
                        ...
                        <h3 class="sub_title">장보고 한옥펜션</h3>
                    </div>
                    <div class="wrap">
                        <div class="box_img">
                            <img src="${path0 }/images/hotel9-1.jpg" id="intro_img1" alt="intro1">
                            <img src="${path0 }/images/hotel9-2.jpg" id="intro_img2" alt="intro2">
                        </div>
                        <div class="intro">
                            <p>
                                <strong>[ 유형 ]</strong> 한옥체험
                                <br><br>
                                <strong>[ 연락처 ]</strong> 010-7155-3585
                                <br><br>
                                <strong>[ 소개글 ]</strong><br>
                                &nbsp;저희 펜션은 우리나라 전통 한옥 고유의 멋과 향수를 잃지 않으면서 펜션여행을 위한 여러가지 편의성을 
                                함께 갖춘 한옥형 펜션입니다.
                                <br>
                                &nbsp;편션라이프에도 소개된바 있는 저희 장보고 한옥펜션에서 아름답고 특색있는 추억을 만들어 보세요.
                            </p>
                        </div>
                       <div class="btn1">
                           <button onclick="window.location.href='https://shorturl.asia/ep1s3'">
