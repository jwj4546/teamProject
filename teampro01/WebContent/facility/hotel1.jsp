               ...
               <div class="contents">
                   ...
                   <h2 class="title">상세보기</h2>
                    <div class="title2">
                        ...
                        <h3 class="sub_title">라르고빌</h3>
                    </div>
                    <div class="wrap">
                        <div class="box_img">
                            <img src="${path0 }/images/hotel1-1.jpg" id="intro_img1" alt="intro1">
                            <img src="${path0 }/images/hotel1-2.jpg" id="intro_img2" alt="intro2">
                        </div>
                        <div class="intro">
                            <p>
                                <strong>[ 유형 ]</strong> 관광호텔
                                <br><br>
                                <strong>[ 객실정보 ]</strong> hotel superior, superior spa, premier, standard, studio suite, imperal
                                <br><br>
                                <strong>[ 연락처 ]</strong> 032-555-8868
                                <br><br>
                                <strong>[ 소개글 ]</strong><br>
                                &nbsp;라르고빌 리조트는 강화도 바닷가에 위치한 고급형 휴양지로써, 강화도의 호텔 및 리조트 산업을 이끌어 나가고 있습니다. 
                                호텔형 타입과 리조트 타입의 객실로 이루어져 있으며 강화도 최대 규모의 연회 시설과 연회장은 물론 카페 'cafe Largo', 
                                야외수영장 'ocean pool', 레스토랑 'the wave restaurant', BBQ 가든, 잔디광장 'garden square' 등 다양한 부대시설을 
                                갖춘 복합 휴양 리조트입니다.
                            </p>
                        </div>
                       <div class="btn1">
                           <button onclick="window.location.href='https://shorturl.asia/CAyma'">
