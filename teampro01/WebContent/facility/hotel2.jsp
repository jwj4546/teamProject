               ...
               <div class="contents">
                   ...
                   <h2 class="title">상세보기</h2>
                    <div class="title2">
                        ...
                        <h3 class="sub_title">노을 내리는 아름다운 집</h3>
                    </div>
                    <div class="wrap">
                        <div class="box_img">
                            <img src="${path0 }/images/hotel2-1.jpg" id="intro_img1" alt="intro1">
                            <img src="${path0 }/images/hotel2-2.jpg" id="intro_img2" alt="intro2">
                        </div>
                        <div class="intro">
                            <p>
                                <strong>[ 유형 ]</strong> 관광펜션
                                <br><br>
                                <strong>[ 연락처 ]</strong> 032-933-9677
                                <br><br>
                                <strong>[ 소개글 ]</strong> 규모 : 276㎡
                            </p>
                        </div>
                       <div class="btn1">
                           <button onclick="window.location.href='https://shorturl.asia/HcK1o'">
