               ...
               <div class="contents">
                   ...
                   <h2 class="title">상세보기</h2>
                    <div class="title2">
                        ...
                        <h3 class="sub_title">천사의 아침</h3>
                    </div>
                    <div class="wrap">
                        <div class="box_img">
                            <img src="${path0 }/images/hotel6-1.jpg" id="intro_img1" alt="intro1">
                            <img src="${path0 }/images/hotel6-2.jpg" id="intro_img2" alt="intro2">
                        </div>
                        <div class="intro">
                            <p>
                                <strong>[ 유형 ]</strong> 민박/펜션
                                <br><br>
                                <strong>[ 객실정보 ]</strong> 5개
                                <br><br>
                                <strong>[ 연락처 ]</strong> 032-937-9612
                                <br><br>
                                <strong>[ 소개글 ]</strong> 없음
                            </p>
                        </div>
                       <div class="btn1">
                           <button onclick="window.location.href='https://shorturl.asia/2FEyR'">
