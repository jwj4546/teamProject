            ...
            <div class="contents_wrap">
                ...
                <div class="contents">
                    ...
                    <div class="title2">
                        ...
                        <h3 class="sub_title">더리미 미술관</h3>
                    </div>
                    <div class="wrap">
                        <div class="box_img">
                            <img src="${path0 }/images/gallery9.jpg" id="intro_img1" alt="gallery9">
                            <img src="${path0 }/images/gallery9_1.jpg" id="intro_img2" alt="gallery9">
                        </div>
                        <div class="intro">
                            <p>1999년 사립미술관으로 등록된 더리미미술관은 작품 전시실, 민속관, 야외전시장, 카페 등으로 이루어져 있으며
                                작품 감상과 더불어 매달 4째주 목요일 음악회를 즐길 수 있다.</p><br>
                            <p>문화센터에서는 미술.음악.영어 교실 등이 운영되고 있으며
                                예약 시 민속관 한옥게스트 하우스를 이용할 수 있다.</p><br><br>
                            <p>소재지 : 인천광역시 강화군 선원면 선원사지로51번길 14 (신정리, 더리미미술관)</p>
                        </div>
                        <div class="btn1">
                            <button onclick="window.location.href='https://www.ganghwa.go.kr/open_content/com/common/map.do?lat=37.7246247&lng=126.5083950&height=600px'">
