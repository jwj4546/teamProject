            ...
            <div class="contents_wrap">
                ...
                <div class="contents">
                    ...
                    <div class="title2">
                        ...
                        <h3 class="sub_title">내가도서관</h3>
                    </div>
                    <div class="wrap">
                        <div class="box_img">
                            <img src="${path0 }/images/library3.jpg" id="intro_img1" alt="library3">
                            <img src="${path0 }/images/library3_1.jpg" id="intro_img2" alt="library3">
                        </div>
                        <div class="intro">
                            <p>유형 : 공공도서관</p><br><br>
                            <p>연락처 : 032-934-1528</p><br><br>
                            <p>쉬는날 : 매주 금요일, 공휴일</p><br><br>
                            <p>운영시간 : 09:00 ~ 18:00</p><br><br>
                            <p>소개글 : 역사의 고장에 위치한 내가군립도서관은 농어촌지역의 종합문화센터로서의 역할과 정보화시대를 선도하는 길잡이로서</p>
                            <p>지식정보의 제공은 물론 사회교육의 기회를 제공하여 평생 교육 기반조성에 힘쓰고 있습니다.</p><br><br>
                            <p>주소 : 인천광역시 강화군 내가면 강화서로 249(고천리, 내가도서관)</p>
                        </div>
                        <div class="btn1">
                            <button onclick="window.location.href='https://www.ganghwa.go.kr/open_content/com/common/map.do?lat=37.71948857052401&lng=126.38995271176464&height=800px'">
