            ...
            <div class="contents_wrap">
                ...
                <div class="contents">
                    ...
                    <div class="title2">
                        ...
                        <h3 class="sub_title">강화벽전도예원</h3>
                    </div>
                    <div class="wrap">
                        <div class="box_img">
                            <img src="${path0 }/images/gallery6.webp" id="intro_img1" alt="gallery6">
                            <img src="${path0 }/images/gallery6_1.jpg" id="intro_img2" alt="gallery6">
                        </div>
                        <div class="intro">
                            <p>도자기 판매 및 도자기 체험 등을 할 수 있다.</p><br><br>
                            <p>소재지 : 인천 강화군 강화동로74번길50-89</p>
                        </div>
                        <div class="btn1">
                            <button onclick="window.location.href='https://www.ganghwa.go.kr/open_content/com/common/map.do?lat=37.6481408&lng=126.5058451&height=600px'">
