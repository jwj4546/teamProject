            ...
            <div class="contents_wrap">
                ...
                <div class="contents">
                    ...
                    <div class="title2">
                        ...
                        <h3 class="sub_title">금도희미술관</h3>
                    </div>
                    <div class="wrap">
                        <div class="box_img">
                            <img src="${path0 }/images/gallery7.jpg" id="intro_img1" alt="gallery7">
                            <img src="${path0 }/images/gallery7_1.jpg" id="intro_img2" alt="gallery7">
                        </div>
                        <div class="intro">
                            <p>화가 금도희의 작품과 제자의 작품을 진열하고 교육을 위한 공간이다.</p><br><br>
                            <p>소재지 : 인천광역시 강화군 내가면 고비고개로743번길 239-23 (고천리, 김도희갤러리)</p>
                        </div>
                        <div class="btn1">
                            <button onclick="window.location.href='https://www.ganghwa.go.kr/open_content/com/common/map.do?lat=37.7138813&lng=126.3942747&height=600px'">
