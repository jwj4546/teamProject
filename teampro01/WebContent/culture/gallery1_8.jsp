            ...
            <div class="contents_wrap">
                ...
                <div class="contents">
                    ...
                    <div class="title2">
                        ...
                        <h3 class="sub_title">담쟁이</h3>
                    </div>
                    <div class="wrap">
                        <div class="box_img">
                            <img src="${path0 }/images/gallery8.jpg" id="intro_img1" alt="gallery8">
                        </div>
                        <div class="intro">
                            <p>넵킨공예전문점으로 출강, 자격증반, 취미반 등을 운영한다.</p><br><br>
                            <p>소재지 : 인천광역시 강화군 강화읍 동문안길 28</p>
                        </div>
                        <div class="btn1">
                            <button onclick="window.location.href='https://www.ganghwa.go.kr/open_content/com/common/map.do?lat=37.7485185&lng=126.4870755&height=600px'">
