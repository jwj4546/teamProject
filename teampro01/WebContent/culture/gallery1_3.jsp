            ...
            <div class="contents_wrap">
                ...
                <div class="contents">
                    ...
                    <div class="title2">
                        ...
                        <h3 class="sub_title">J2갤러리</h3>
                    </div>
                    <div class="wrap">
                        <div class="box_img">
                            <img src="${path0 }/images/gallery3.jpg" id="intro_img1" alt="gallery3">
                            <img src="${path0 }/images/gallery3_1.jpg" id="intro_img2" alt="gallery3">
                        </div>
                        <div class="intro">
                            <p>서양화가 정지권의 작품을 감상할 수 있는 카페형 갤러리이다.</p><br><br>
                            <p>소재지 : 인천광역시 강화군 내가면 강화서로227번길 49 (고천리)</p>
                        </div>
                        <div class="btn1">
