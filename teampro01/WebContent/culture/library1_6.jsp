            ...
            <div class="contents_wrap">
                ...
                <div class="contents">
                    ...
                    <div class="title2">
                        ...
                        <h3 class="sub_title">화도작은도서관</h3>
                    </div>
                    <div class="wrap">
                        <div class="box_img">
                            <img src="${path0 }/images/library6.jpg" id="intro_img1" alt="library6">
                        </div>
                        <div class="intro">
                            <p>유형 : 공공도서관</p><br><br>
                            <p>연락처 : 032-930-4243</p><br><br>
                            <p>쉬는날 : 토·일요일, 공휴일</p><br><br>
                            <p>운영시간 : 평일 09:00 ~ 18:00</p><br><br>
                            <p>소개글 : 지역주민의 사랑방 역할을 하는 생활친화적 문화공간</p><br><br>
                            <p>주소 : 인천광역시 강화군 화도면 마니산로 703-14 (상방리)</p>
                        </div>
                        <div class="btn1">
                            <button onclick="window.location.href='https://www.ganghwa.go.kr/open_content/com/common/map.do?lat=37.6318073&lng=126.419985&height=800px'">
