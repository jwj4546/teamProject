            ...
            <div class="contents_wrap">
                ...
                <div class="contents">
                    ...
                    <div class="title2">
                        ...
                        <h3 class="sub_title">강화군 새마을작은도서관</h3>
                    </div>
                    <div class="wrap">
                        <div class="box_img">
                            <img src="${path0 }/images/library7.jpg" id="intro_img1" alt="library7">
                        ...
                        <div class="btn1">
                            <button onclick="window.location.href='https://www.ganghwa.go.kr/open_content/com/common/map.do?lat=37.7463978&lng=126.4784309&height=800px'">
